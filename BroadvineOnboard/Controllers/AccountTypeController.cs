...
namespace BroadvineOnboard.Controllers
{
    public class AccountTypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccountTypeID,ClientID,Name")] AccountType accountType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccountTypeID,ClientID,Name")] AccountType accountType)
        {
            if (ModelState.IsValid)
            {
